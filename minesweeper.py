...
class MinesweeperAI:
    ...
    def add_knowledge(self, cell, count):
        ...
        for cell in nearby_cells:
            if cell in self.safes | self.mines:
        ...
        # Mark any additional cells as safe or as mines with new sentence added
        mark(self)
        ...
        for sentence1 in self.knowledge:
            for sentence2 in self.knowledge:
                if sentence1.cells > sentence2.cells:
                    newer_sentence = Sentence(list(sentence1.cells - sentence2.cells), sentence1.count - sentence2.count)
                    if newer_sentence.count >= 0:
                        new_sentences.append(newer_sentence)
        self.knowledge.extend(new_sentences)

        # Mark any additional cells as safe or as mines with newer sentences added
        mark(self)
    ...
    def make_random_move(self):
        ...
        while True:
            ...
            if random_move not in self.moves_made | self.mines:
                break
        return random_move
